    ...
    return [
      ...
      // Entity Name
      {
        ...
        info: {
          ...
          description:
            "@{Auria.Columns.EntityProcedurePermission.EntityName.Description}",
        },
        schema: {
      ...
      // User ID
      {
        ...
        info: {
          ...
          description:
            "@{Auria.Columns.EntityProcedurePermission.UserID.Description}",
        },
        schema: {
          column_name: "user_id",
          sql_type: "CHAR",
      ...
      // Role ID
      {
        ...
        info: {
          ...
          description:
            "@{Auria.Columns.EntityProcedurePermission.RoleID.Description}",
        },
        schema: {
          column_name: "role_id",
          sql_type: "CHAR",
      ...
      // Procedure
      {
        ...
        info: {
          ...
          description:
            "@{Auria.Columns.EntityProcedurePermission.Procedure.Description}",
        },
        schema: {
  ...
  constructor() {
    ...
    this.addReferences(
      // Entity Name
      {
        ...
        table: SystemEntityCatalog.EntityProcedurePermission.table_name,
        entity: SystemEntityCatalog.EntityProcedurePermission.name,
        column: "entity_name",
        references: {
          column: "name",
