...
export class LoginAttemptManager {
     ...
     * @param request 
     */
    public requestLoginAttempt(request: ISystemRequest): LoginAttempt {

        let reqId: LoginAttempIdentification = request.referer!;
     ...
     * @param request 
     */
    public clearLoginAttempts(request: ISystemRequest): {
        perUsername: LoginAttempt[],
        perIdentification: LoginAttempt[]
    } {

        let username: string = request.parameters['username'];
        let id: string = this.getStringFromIdentification(request.referer);
     ...
     * @param request 
     */
    private createLoginAttempt(request: ISystemRequest): LoginAttempt {
